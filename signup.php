           ...
           <div class="col-lg-6"> 
            ...
            <div class="col-lg-6">
             ...
             <div class="form-group">
              <div class="col-md-12">
                <label class="col-md-4 control-label" for=
                "CITYADD">Province:</label>

                <div class="col-md-8">
                   <input class="form-control input-sm" id="CITYADD" name="CUSTPROVINCE" placeholder=
                      "Province Address" type="text" value="<?php echo $res->CUSTPROVINCE; ?>">
                </div>
              </div>
            </div>
