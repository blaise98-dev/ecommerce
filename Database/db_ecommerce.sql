...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2021 at 11:40 AM
...
CREATE TABLE `tblcustomer` (
  ...
  `CUSTPROVINCE` text NOT NULL,
  `CUSTDISTRICT` varchar(234) NOT NULL,
  `CUSTSECTOR` varchar(123) NOT NULL,
  `CUSTCELL` varchar(245) NOT NULL,
  `CUSTVILLAGE` varchar(234) NOT NULL,
...
INSERT INTO `tblcustomer` (`CUSTOMERID`, `FNAME`, `LNAME`, `MNAME`, `CUSHOMENUM`, `STREETADD`, `BRGYADD`, `CUSTPROVINCE`, `CUSTDISTRICT`, `CUSTSECTOR`, `CUSTCELL`, `CUSTVILLAGE`, `COUNTRY`, `DBIRTH`, `GENDER`, `PHONE`, `EMAILADD`, `ZIPCODE`, `CUSUNAME`, `CUSPASS`, `CUSPHOTO`, `TERMS`, `DATEJOIN`) VALUES
(16, 'Jeannette', 'Uwiringiyimana', '', '', '', '', 'Kigali', 'Nyarugenge', 'Nyarugenge', 'Biryogo', '', '', '0000-00-00', 'Female', '0789310350', '', 0, 'mugisha', '3983b340c58f0f35188125b7dc969309ca65620d', '', 1, '2021-10-25'),
(17, 'Blaise', 'NINDENKIMANA', '', '', '', '', 'North', 'Gicumbi', 'Bwisige', 'Mukono', 'Akavuza', '', '0000-00-00', 'Male', '0783530924', '', 0, 'mugisha', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', '', 1, '2021-10-25'),
(18, 'Blaise', 'NINDENKIMANA', '', '', '', '', 'West', 'Rutsiro', 'Mushubati', 'Cyarusera', 'Bivumu', '', '0000-00-00', 'Male', '0783530924', '', 0, 'mugisha', 'eaf1131624e9ba3004004bfd65671a087c7780ab', '', 1, '2021-10-25'),
(19, 'CELESTIN', 'HABINEZA', '', '', '', '', 'South', 'Nyaruguru', 'Muganza', 'Samiyonga', 'Cyurukore', '', '0000-00-00', 'Male', '', '', 0, 'HABINEZA', '6ddb52dd834e6bd3ca1388132569fa29ea334a91', 'customer_image/IMG-20210827-WA0047.jpg', 1, '2021-10-26'),
(20, 'Fidel', 'Ndayishimiye', '', '', '', '', 'South', 'Nyaruguru', 'Muganza', 'Uwacyiza', 'Mutovu', '', '0000-00-00', 'Male', '0789310350', '', 0, 'fidel', 'd72565831848bce7dfa66096e1be62f76f2cd573', '', 1, '2021-10-26');
...
INSERT INTO `tblorder` (`ORDERID`, `PROID`, `ORDEREDQTY`, `ORDEREDPRICE`, `ORDEREDNUM`, `CUSTOMERID`) VALUES
(1, 201737, 4, 476, 93, 0),
(2, 201740, 3, 447, 93, 0),
(3, 201738, 1, 199, 94, 0),
(4, 201737, 1, 119, 95, 0),
...
(8, 201739, 1, 289, 98, 0),
(9, 201741, 1, 89, 98, 0),
(10, 201740, 1, 149, 98, 0),
(11, 201741, 1, 89, 102, 0),
(12, 201737, 3, 357, 103, 0),
(13, 201738, 1, 199, 103, 0),
(14, 201741, 2, 178, 103, 0),
(15, 201739, 1, 289, 104, 0),
(16, 201739, 1, 289, 105, 0),
(17, 201739, 1, 289, 106, 0),
(18, 201739, 1, 289, 107, 0),
(19, 201738, 1, 199, 108, 0),
(20, 201738, 1, 199, 109, 0),
(21, 201738, 1, 199, 110, 0),
(22, 201738, 1, 199, 111, 0),
(23, 201738, 1, 199, 112, 0),
(24, 201738, 2, 398, 113, 0),
(25, 201737, 23, 2737, 114, 0);
...
(201737, 'RICE AND MILK                                                          ', '', 0, 125, 119, 12, 'uploaded_photos/korean.jpeg', 'NotAvailable', 'Blaise Nindenkimana', ''),
(201738, 'terno top and pants korean fashion boho terno summer terno for women                        ', '', 5, 150, 199, 12, 'uploaded_photos/terno.jpg', 'Available', 'janobe', ''),
(201739, '4Color Menâ€²S Denim Pants STRETCHABLE Skinny Black/Blue', '', 0, 250, 289, 18, 'uploaded_photos/jeans.jpg', 'Available', 'janobe', ''),
(201740, 'SIMPLE Fashion Men`S Casual T Shirt Short Sleeve Round neck Top', '', 0, 100, 149, 18, 'uploaded_photos/shirt.jpg', 'NotAvailable', 'janobe', ''),
(201741, 'ICM #T146 BESTSELLER TOPS TSHIRT FOR MEN', '', 0, 50, 89, 18, 'uploaded_photos/shirt2.jpg', 'Available', 'janobe', ''),
...
CREATE TABLE `tblsetting` (
  ...
  `cell` varchar(123) NOT NULL,
  `village` varchar(124) NOT NULL,
...
INSERT INTO `tblsetting` (`SETTINGID`, `province`, `district`, `sector`, `cell`, `village`, `DELPRICE`, `CUSTOMERID`) VALUES
(1, 'West', 'Rusizi', 'Nzahaha', '', '', 50, 0),
(2, 'East', 'Nyagatare', 'Karangazi', '', '', 70, 0),
(3, 'Kigali', 'Nyarugenge', 'Gitega', '', '', 200, 0),
(4, 'North', 'Burera', 'Ruhunde', 'Gitovu', 'Ngoma', 456, 0),
(5, '0', '0', '0', '0', '0', 0, 0),
(6, 'East', 'Gatsibo', 'Rugarama', 'Bugarama', '0', 2300, 0);
...
(4, '2021-10-12 12:39:28', 10, 95, 50, 169, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 1, 0),
(5, '2021-10-19 03:40:17', 11, 96, 50, 318, 'Cash on Delivery', 'Confirmed', 'Your order has been confirmed.', '2021-10-19 00:00:00', 1, 0),
(7, '2021-10-19 03:47:28', 11, 97, 70, 199, 'Cash on Delivery', 'Confirmed', 'Your order has been confirmed.', '2021-10-19 00:00:00', 1, 0),
(8, '2021-10-19 04:21:24', 11, 98, 70, 527, 'Cash on Delivery', 'Cancelled', 'Your order has been cancelled due to lack of communication and incomplete information.', '0000-00-00 00:00:00', 1, 0),
(11, '2021-10-26 10:04:30', 18, 102, 0, 89, 'Cash on Delivery', 'Confirmed', 'Your order has been confirmed.', '2021-10-26 00:00:00', 1, 0),
(12, '2021-10-26 10:34:27', 19, 103, 200, 734, 'Cash on Delivery', 'Confirmed', 'Your order has been confirmed.', '2021-10-26 00:00:00', 1, 0),
(15, '2021-10-26 11:07:01', 19, 104, 0, 289, 'Cash on Delivery', 'Cancelled', 'Your order has been cancelled due to lack of communication and incomplete information.', '0000-00-00 00:00:00', 0, 0),
(16, '2021-10-26 12:26:20', 19, 105, 0, 289, 'Cash on Delivery', 'Confirmed', 'Your order has been confirmed.', '2021-10-26 00:00:00', 1, 0),
(17, '2021-10-26 12:32:20', 19, 106, 0, 289, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 0, 0),
(18, '2021-10-26 01:01:17', 19, 107, 0, 289, 'Cash on Delivery', 'Cancelled', 'Your order has been cancelled due to lack of communication and incomplete information.', '0000-00-00 00:00:00', 0, 0),
(19, '2021-10-26 01:09:20', 19, 108, 0, 199, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 1, 0),
(20, '2021-10-26 01:22:46', 19, 109, 0, 199, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 0, 0),
(21, '2021-10-26 03:10:01', 19, 110, 0, 199, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 0, 0),
(22, '2021-10-26 03:39:05', 19, 111, 0, 199, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 1, 0),
(23, '2021-10-26 03:45:52', 19, 112, 0, 199, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 1, 0),
(24, '2021-10-26 04:13:54', 19, 113, 0, 398, 'Cash on Delivery', 'Pending', 'Your order is on process.', '0000-00-00 00:00:00', 0, 0),
(25, '2021-10-26 04:52:16', 20, 114, 0, 2737, 'Cash on Delivery', 'Confirmed', 'Your order has been confirmed.', '2021-10-26 00:00:00', 1, 0);
...
(124, 'Mugisha Narcisse', 'mugisha', '356a192b7913b04c54574d18c28d46e6395428ab', 'Encoder', 'photos/IMG-20210827-WA0057.jpg'),
(126, 'Blaise NINDENKIMANA', 'Blaise ', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Administrator', 'photos/10329236_874204835938922_6636897990257224477_n.jpg'),
(127, 'Ishimael Ndayambaje', 'ishimael', '356a192b7913b04c54574d18c28d46e6395428ab', 'Administrator', ''),
(128, 'Celestin', 'celestin', '356a192b7913b04c54574d18c28d46e6395428ab', 'Staff', '');
...
(3, 10, 201738, '2021-10-12', '0'),
(4, 19, 201739, '2021-10-26', '0');
