                         ...
                         <div class="tab-pane fade in active" id="home">
                             ...
                             <div class="panel panel-pup">
                                 ...
                                 <div class="panel-footer">
                                     <p align="left">&copy; <a href="#">Blaise NINDENKIMANA</a></p>
                                 </div>
                             </div>
                         </div>
                         <!-- end login panel -->
                                     ...
                                     <div class="panel-body">
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-10">
                                                 ...
                                                 <div class="col-md-8">
                                                     <select class="form-control cell-input-sm" name="CUSTCELL"
                                                         id="cell-dropdown" required>
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-10">
                                                 ...
                                                 <div class="col-md-8">
                                                     <select class="form-control cell-input" name="CUSTVILLAGE"
                                                         id="village-dropdown" required>
