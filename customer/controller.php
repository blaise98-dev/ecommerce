...
function doInsert(){
	...
	if(isset($_POST['submit'])){
						...
						$customer->CUSTPROVINCE 	= $_POST['CUSTPROVINCE']; 
						$customer->CUSTDISTRICT  	= $_POST['CUSTDISTRICT'];
						$customer->CUSTSECTOR  		= $_POST['CUSTSECTOR'];
						$customer->CUSTCELL  		= $_POST['CUSTCELL'];
						$customer->CUSTVILLAGE  	= $_POST['CUSTVILLAGE'];
