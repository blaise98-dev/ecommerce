  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center"> 
				<h1><span style="color:#fe980f;">M-</span>Store</h1>
 	 ...
 	 <h4>Your order has been confirmed and ready for Pick Up</h4><br/>
		...
		<h5>As you have ordered cash on pick up, please have the exact amount of cash to pay to our staff and bring this billing details.</h5>
		 ...
		 <div class="row">
		 	...
		 	<p>Address : <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . ' ' .$cur->CUSTPROVINCE . ' ' . $cur->CUSTDISTRICT. ' ' .$cur->CUSTSECTOR . ' ' .$cur->COUNTRY; ?></p>
		...
		?>
 		...
 		<div class="row">
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  <!-- put my link through -->
		  	  <h4><a href="#">Blaise NINDENKIMANA</a></h4>
		  </div>
		  <?php }?>
  </div> 
