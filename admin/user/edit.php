                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          ...
                          <option value="Staff" <?php echo ($singleuser->U_ROLE=='distributor') ? 'selected="true"': '' ; ?>>Staff</option> 
                          <!-- <option value="Customer">Customer</option> -->
                          <option value="Encoder" <?php echo ($singleuser->U_ROLE=='distributor') ? 'selected="true"': '' ; ?>>Encoder</option>
                        </select> 
                      </div>
                    </div>
                  </div>
