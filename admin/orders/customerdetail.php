...
-->
     <div class="col-md-12"> 
        <div class="col-md-6">
           <label><?php echo $res->CUSTPROVINCE; ?></label> 
               <p>Province::</p>  
        </div>
    </div>
    ...
    <div class="col-md-12"> 
        <div class="col-md-6">
           <label><?php echo $res->CUSTDISTRICT; ?></label> 
               <p>District::</p>  
        </div>
    </div>
    <div class="col-md-12"> 
        <div class="col-md-6">
           <label><?php echo $res->CUSTSECTOR; ?></label> 
               <p>Sector::</p>  
        </div>
    </div>
    <div class="col-md-12"> 
        <div class="col-md-6">
           <label><?php echo $res->CUSTCELL; ?></label> 
               <p>Cell::</p>  
        </div>
    </div>
    <div class="col-md-12"> 
        <div class="col-md-6">
           <label><?php echo $res->CUSTVILLAGE; ?></label> 
               <p>Village::</p>  
        </div>
    </div>
