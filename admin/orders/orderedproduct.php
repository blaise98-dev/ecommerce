...
<div class="modal-content">
	...
	<div class="row" style="margin:2%">
		...
		<div class="col-md-6">Address:  <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . '  ' . $cur->CUSTPROVINCE . ', ' .$cur->CUSTDISTRICT . ',' .$cur->CUSTSECTOR . ', ' .$cur->CUSTCELL . ', ' .$cur->CUSTVILLAGE . ' ' .$cur->COUNTRY; ?>
     </div>
	</div>
