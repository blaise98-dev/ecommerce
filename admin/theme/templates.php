    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo web_root; ?>admin/index.php">Group E-Commerce</a>
            </div>
            <!-- /.navbar-header -->
...
?>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Me, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="17px"
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?php echo web_root; ?>admin/customer/index.php"><i class="fa fa-user fa-fw"></i>
                        Customers</a>
...
<footer>
    <p style="text-align: center;font-weight: bold;">Copyright &copy; M-shop store </p>
</footer>
