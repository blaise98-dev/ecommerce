...
if (isset($_POST['updateid'])){  
 // require_once ("include/initialize.php");
    ...
    for($i=0;$i<$max;$i++){
      ...
      $pid=$_SESSION['fixnmix_'][$i]['productid'];
    ...
    <div id="cart">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <fieldset>
                                ...
                                <div>Every products has a mininum price of &#36; 5.00 each to be able to order.</div>
            ...
            ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>"
                                                            ...
                                                            class="delete btn btn-danger btn-xs">Remove</a></td>
                                                </tr>
                                                <?php
              }
        ...
        ?>
                                    ...
                                    <table>
                                        <tfoot>
                                            <strong>
                                                <h1 align="right">Total Price : &#36; <span style="margin-right:3%"
                                                        id="sum">0.00</span></h1>
                                            </strong></td>
        ...
        <?php    
                             ...
                             echo '<a href="index.php?page=2" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Add Another Products</strong></a>';
                                ...
                                if (isset($_SESSION['cus_id'])){  
                                  ...
                                  echo '<button type="submit"  name="btnorder" id="proceed" class="btn btn_fixnmix pull-right"   ><strong>Proceed And Checkout</strong><span class="glyphicon glyphicon-chevron-right"></button>';
                            ...
                            <form action="login.php" onsubmit="return validatepasswords()" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <p align="left">&copy; Fix M-shop Ordering System</p>
