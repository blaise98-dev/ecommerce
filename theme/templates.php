  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +250 738 073 676</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> tontomugisha@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
    ...
    <div class="header-middle"><!--header-middle-->
      ...
      <ul class="nav navbar-nav collapse navbar-collapse">
        <li> <a href="<?php echo web_root?>"><!--<img src="images/logo2.jpg" alt="" style="width:60px"/> -->
              <span style="font-size:24px; padding-lef:-200p; color:#FE980F;">M-<b style="color:#000;">store</b> </span> </a>
      </li>
    ...
    <!-- embedding tweets on website -->
    <!-- <a class="twitter-timeline" data-tweet-limit="5"  href="https://twitter.com/NindenkimanaBl1?ref_src=twsrc%5Etfw">Tweets by NindenkimanaBl1</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script><div class="footer-widget">
      -->
      <div class="container"> 
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="#">mugisha-web@github.com</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="#">y3 computer science group2</a></span></p>
        </div>
      </div>
    </div>
...
<script src="<?php echo web_root; ?>js/radios.js"></script> 
<script src="<?php echo web_root; ?>js/main.js"></script> 
<script src="<?php echo web_root; ?>https://code.jquery.com/jquery-3.5.1.min.js"></script>
